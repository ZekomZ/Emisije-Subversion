...
/**
@module Trains-Editor
*/
/**@inner*/
var TrainStations =[new google.maps.LatLng(45.886277,13.902437),
...
for (i=0; i<StationsData.length; i++ )
{
    ...
    StationsInfoText.push( "Zelezniska postaja " + TrainStationsData[i][1] + "<br/>" +
            "ID: " + TrainStationsData[i][0] + "<br/>" +
            "Name: " + TrainStationsData[i][1] +
            "Latitude:"+TrainStations[i].lat()+"<br/>"+
            "Longitude:"+TrainStations[i].lng()+"" );
