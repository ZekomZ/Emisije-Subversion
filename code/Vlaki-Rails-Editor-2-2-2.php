...
// Version 1.2.3
.. To DO :
- SQL insert statement ( insert into Train_Rails values )
- StationA and StationB markers set Start/End of a rail
- Markers cannot change, when editing
- Delete all markers button

// Version 1.1.3

// Version 1.1.2
Changes function AddStationMarkers() -- Added listeners for individual stationMarker events
Addded function SelectStationMarker(markerID) -- Function will set markers for trainStationA and TrainStationB according to onlistener events in addStationMarkers
Added function ZoomStationA () -- Pan/Zoom to trainStationA
